...
def parse_arguments():
    ...
    parser.add_argument("--model_name", type=str, default= "TheBloke/Wizard-Vicuna-7B-Uncensored-HF", help="Model name")
...
class ModelMiner():
    ...
    def __init__( self, model_name, device="cuda", max_length=300, temperature=0.65, do_sample=True ):
